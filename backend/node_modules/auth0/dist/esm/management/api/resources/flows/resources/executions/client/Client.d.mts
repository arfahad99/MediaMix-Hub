...
export declare class ExecutionsClient {
     ...
     *     })
     */
    list(flow_id: string, request?: Management.ExecutionsListRequest, requestOptions?: ExecutionsClient.RequestOptions): Promise<core.Page<Management.FlowExecutionSummary, Management.ListFlowExecutionsPaginatedResponseContent>>;
    /**
     * @param {string} flow_id - Flow id
     ...
     */
    get(flow_id: string, execution_id: string, request?: Management.ExecutionsGetRequest, requestOptions?: ExecutionsClient.RequestOptions): core.HttpResponsePromise<Management.GetFlowExecutionResponseContent>;
    private __get;
    /**
